                    ...
                    <div class="card-body border-top p-9">
                        ...
                        <div class="row mb-5 g-4">
                            ...
                            <div class="col-md-2 mt-13 d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                                <button v-if="checkPermission('can-create-buyer')" type="button" class="btn btn-primary px-3" data-bs-toggle="modal" data-bs-target="#kt_modal_add_buyer_for_sale" style="height:auto">
