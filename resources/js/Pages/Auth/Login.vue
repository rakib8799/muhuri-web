            ...
            <div class="d-flex flex-lg-row-fluid">
                ...
                <div class="d-flex flex-column flex-center pb-0 pb-lg-10 p-10 w-100">
                    ...
                    <div class="text-gray-600 fs-base text-center fw-semibold">
                        <p>পোনা ক্রয় হিসাব, মাছ বিক্রয় হিসাব, বকেয়া আদায় - সকল হিসাব থাকে চোখের সামনে। হিসাবের ডাটা হারানোর কোনো ভয় নেই। রেজিস্ট্রেশন করলেই পাচ্ছেন ৬ মাসের সাবস্ক্রিপশন ফ্রী।</p>
                        <p>ব্যাবসা আপনার, হিসাব রাখার দায়িত্ব মুহুরীর। মুহুরী ওয়েব এর মাধ্যমে আপনার ঘেরের সকল হিসাব রাখতে পারবেন আরো সহজে ও নিরাপদে। তাই আরো দক্ষভাবে হিসাব করুন মুহুরীর মাধ্যমে।</p>
                    </div>
                    <!--end::Text-->
                </div>
                <!--end::Content-->
                        ...
                        <div class="d-flex flex-center flex-column flex-column-fluid pb-15 pb-lg-20">
                            ...
                            <VForm class="form w-100" id="kt_sign_in_form" data-kt-redirect-url="index.html"
                                ...
                                <div class="d-flex flex-stack flex-wrap gap-3 fs-base fw-semibold mb-8">
                                    <div></div>
                                    <Link :href="route('password.request')" class="link-primary">
