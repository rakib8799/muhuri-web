                            ...
                            <div class="card-body">
                                ...
                                <div id="kt_user_view_details" class="collapse show">
                                    <div class="pb-5 fs-6">
                                        ...
                                        <div class="text-gray-600">
                                            <a href="#" class="text-gray-600 text-hover-primary">
                                                {{ Math.abs(props.supplierSummary?.total_due || 0) }}
                                            </a>
                                        </div>
                                        <!--begin::Details item-->
                                    </div>
                                ...
                                <div class="card card-flush mb-6 mb-xl-9">
                                    ...
                                    <div class="card-body">
                                        ...
                                        >
                                            <!-- Date -->
                                            <template
                                                v-slot:payment_date="{ row: supplierPayment }">
                                            ...
                                            <!-- Action -->
                                            <template
                                                v-slot:actions="{ row: supplierPayment }">
                                                <div class="d-flex align-items-center justify-content-end">
                                                    ...
                                                    <!-- Delete -->
                                                    <DeleteConfirmationButton v-if="checkPermission('can-delete-supplier-payment')"iconClass="fs-1" :supplierId="props?.supplier?.id" :payment="supplierPayment" confirmRoute="suppliers.payments.destroy" title="Supplier Payment" :messageTitle="`${supplierPayment?.payment_date} তারিখের ${supplierPayment?.amount} টাকার পেমেন্ট?`"/>

                                                    <Link :href="route('suppliers.payments.show', [props.supplier?.id, supplierPayment?.id])" class="btn btn-icon btn-flex btn-active-light-primary w-30px h-30px" data-bs-toggle="tooltip" :title="$t('tooltip.title.view')">
                                                        <KTIcon icon-name="book" icon-class="fs-3 text-primary"/>
                                                    </Link>
                                                </div>
                                            </template>
                            ...
                            <div id="branch_details" class="py-4 tab-pane fade active show" role="tabpanel" v-show="activeTab === 3">
                                <div class="card card-flush mb-6 mb-xl-9">
                                    <div class="card-header mt-6">
                                        <div class="card-title">
                                            <div class="d-flex align-items-center position-relative my-1">
                                                <h2>{{ $t('supplier.label.atAGlance') }}</h2>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card-body">
    ...
    if (props.supplierPayments) {
        initSupplierPayments.value = props.supplierPayments.map(
            (supplierPayment: any) => ({
                ...
                waiver_amount: supplierPayment.waiver_amount,
