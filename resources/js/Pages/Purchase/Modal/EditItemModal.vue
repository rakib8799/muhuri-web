<template>
    <div class="modal fade" id="kt_modal_edit_purchase" ref="editPurchaseModalRef" tabindex="-1" aria-hidden="true">
...
const submit = () => {
    if (validateForm()) {
        ...
        formData.total_box = isTargetItem.value ? 0 : props.item?.total_box;
        formData.total_poly = isTargetItem.value ? 0 : props.item?.total_poly;
        formData.mir = isTargetItem.value ? 0 : props.item?.mir;
        formData.quantity = isTargetItem.value ? 0 : props.item?.quantity;
