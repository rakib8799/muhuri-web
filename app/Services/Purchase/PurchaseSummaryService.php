...
class PurchaseSummaryService extends BaseModelService
{
    ...
    public function firstOrCreatePurchaseSummary($sale, $saleItem)
    {
    ...
    public function addPurchaseItemToSummary($sale, $saleItem)
    {
        $saleSummary = $this->firstOrCreatePurchaseSummary($sale, $saleItem);
    ...
    public function removePurchaseItemFromSummary($sale, $saleItem)
    {
        $saleSummary = $this->firstOrCreatePurchaseSummary($sale, $saleItem);
        $saleSummary->total_quantity -= $saleItem->quantity;
        $saleSummary->total_amount -= $saleItem->total_price;
