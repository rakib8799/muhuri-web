...
class SupplierController extends Controller implements HasMiddleware
{
    ...
    public function store(CreateSupplierRequest $request)
    {
        ...
        if ($request->routeIs('sales.supplier.store')) {
            return redirect()->route('sales.create', ['supplier' => $supplier->id])->with($status, $message);
        } else if ($request->routeIs('sales.others.supplier.store')) {
            return redirect()->route('sales.others.create', ['supplier' => $supplier->id])->with($status, $message);
        }
