...
class SaleController extends Controller implements HasMiddleware
{
    ...
    public static function middleware(): array
    {
        return[
            ...
            new middleware('permission:can-create-sale', only: ['create']),
            new middleware('permission:can-edit-sale', only: ['edit']),
        ];
    }
    ...
    public function update(UpdateSaleRequest $request, Sale $sale)
    {
        ...
        $message = $isUpdated ? 'Sale Updated Successfully' : 'Sale could not be updated';
    ...
    public function destroy(Sale $sale)
    {
        ...
        $message = $isDeleted ? 'Sale deleted successfully' : 'Sale could not be deleted';
        return redirect()->route('sales.index')->with($status, $message);
    }
